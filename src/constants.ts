...
export enum ParticipantMSG {
    ...
    FIND_PARTICIPANT_BY_RUT = 'FIND_PARTICIPANT_BY_RUT',
}
...
export enum TaskMSG {
    ...
    UPDATE = 'UPDATE_TASK',
    DELETE = 'DELETE_TASK',
    FIND_TASKS_BY_PROJECT = 'FIND_TASKS_BY_PROJECT',
}
...
export enum TeamMSG {
    ...
    FIND_PROJECTS_BY_TEAM = 'FIND_PROJECTS_BY_TEAM',
}
...
export enum TeamParticipantMSG {
    ...
    FIND_PARTICIPANTS_BY_TEAM = "FIND_PARTICIPANTS_BY_TEAM",
    FIND_PROJECTS_BY_PARTICIPANT = 'FIND_PROJECTS_BY_PARTICIPANT',
    FIND_PARTICIPANTS_BY_PROJECT = 'FIND_PARTICIPANTS_BY_PROJECT',
    FIND_ROLES_BY_PARTICIPANT_AND_TEAM = 'FIND_ROLES_BY_PARTICIPANT_AND_TEAM',
}
